    ...
    <script type="text/javascript">
        ...
        function searchOrderlist() {
            ...
            if(str==null){
                ...
                $("#body").load("/getOrderInfos/searchOrderListByUsername?searchStr=" + str);
            }
        }
        ...
        function queryInfo(pageNum, pageSize) {
            $("#body").load("/getOrderInfos/getOrderAllList?pageNum=" + pageNum + "&pageSize=" + pageSize);
        }
    </script>
</head>
...
<div id="body">
    ...
    <div id="header">
        ...
        <ul id="menu">
            ...
            <li><a href="" class="active">订单信息</a></li>
            <li><a href="/">退出登录</a></li>
        </ul>
    </div>
    <!-- 搜索添加 -->
        ...
        <div id="search_area">
            <form class="condition_search">
                <div class="film_search form-inline">
                    ...
                    <button type="button" class="btn inline" id="btn_search" onclick="searchOrderlist()">搜索</button>
                </div>
            </form>
        </div>
    ...
    <div id="container">
        <!-- 列表 -->
        <div id="list" class="center list menu_info_list">
            <ul class="list_tag">
                <li>订单号</li>
                <li>电影名称</li>
                <li>用户id</li>
