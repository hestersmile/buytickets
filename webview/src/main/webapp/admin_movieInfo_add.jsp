...
<div id="container">
    <div id="list" class="add update center">
        <form action="/getMovieInfos/uploadMovieInfos" method="post" id="movie_update"  enctype="multipart/form-data" >
            <ul class="list_detail center">
                <li class="list_title">电影信息添加</li>
                <li><label>电影名称</label> &nbsp;<input class="form-control" type="text" name="movieTitle" id="movieTitle"  ></li>
                <li><label>电影简介</label> &nbsp;<textarea class="form-control" name="movieInfo" cols="30" rows="10"id="movieInfo" ></textarea>
                </li>
                <li><label>电影总票数</label> &nbsp;<input class="form-control" type="text" name="movieNum" id="movieNum" ></li>
                <li><label>电影现有票数</label> &nbsp;<input class="form-control" type="text" name="movieTempNum" id="movieTempNum"></li>
                <li><label>电影演员表</label> &nbsp;<input class="form-control" type="text" name="movieActor" id="movieActor"></li>
                ...
                <li><label>电影海报名称</label> &nbsp;<input class="form-control" type="text" name="movieImgName" id="movieImgName"></li>
                <li class="operation">
