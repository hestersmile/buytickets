...
<div id="container">
    <div id="list" class="center detail">
        <ul class="list_detail center">
            <li class="list_title">订单信息详情</li>
            <li>订单id&nbsp;${userdetails.id}</li>
            <li>用户id&nbsp;${userdetails.musername}</li>
            <li>用户名称&nbsp;${userdetails.id}</li>
            <li>电影id&nbsp;${userdetails.movieid}</li>
            <li>电影名称&nbsp;${userdetails.movieTitle}</li>
            <li>订单购买时间&nbsp; ${userdetails.ordertime}</li>
            <li>订单数量&nbsp; ${userdetails.ordernum}</li>
        </ul>
    </div>
</div>
<!-- 页尾 -->
